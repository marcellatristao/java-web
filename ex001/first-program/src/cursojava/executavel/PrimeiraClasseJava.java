...
public class PrimeiraClasseJava {
	...
	public static void main(String[] args) {	
		...
		aluno2.setIdade(16);
		aluno2.setDataNascimento("05/02/2000");
		aluno2.setRegistroGeral("0000000");
		aluno2.setNumeroCpf("000-000-000-00");
		aluno2.setNomeMae("Maria");
		aluno2.setNomePai("João");
		aluno2.setDataMatricula("10/02/2019");
		aluno2.setNomeEscola("Auxiliadora");
		aluno2.setSerieMatriculada("6ª");	
